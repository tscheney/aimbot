...
(cl:defmethod cl:initialize-instance :after ((m <PIDInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PIDInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aimbot-msg:<PIDInfo> is deprecated: use aimbot-msg:PIDInfo instead.")))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <PIDInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimbot-msg:error-val is deprecated.  Use aimbot-msg:error instead.")
  (error m))

(cl:ensure-generic-function 'desired-val :lambda-list '(m))
(cl:defmethod desired-val ((m <PIDInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimbot-msg:desired-val is deprecated.  Use aimbot-msg:desired instead.")
  (desired m))

(cl:ensure-generic-function 'actual-val :lambda-list '(m))
(cl:defmethod actual-val ((m <PIDInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aimbot-msg:actual-val is deprecated.  Use aimbot-msg:actual instead.")
  (actual m))
