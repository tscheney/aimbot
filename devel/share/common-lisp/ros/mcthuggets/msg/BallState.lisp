...
(cl:defmethod cl:initialize-instance :after ((m <BallState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BallState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mcthuggets-msg:<BallState> is deprecated: use mcthuggets-msg:BallState instead.")))
