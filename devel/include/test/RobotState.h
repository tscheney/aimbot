// Generated by gencpp from file test/RobotState.msg
// DO NOT EDIT!


#ifndef TEST_MESSAGE_ROBOTSTATE_H
#define TEST_MESSAGE_ROBOTSTATE_H
...
struct RobotState_
{
  ...
  typedef boost::shared_ptr< ::test::RobotState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::test::RobotState_<ContainerAllocator> const> ConstPtr;

}; // struct RobotState_

typedef ::test::RobotState_<std::allocator<void> > RobotState;

typedef boost::shared_ptr< ::test::RobotState > RobotStatePtr;
typedef boost::shared_ptr< ::test::RobotState const> RobotStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::test::RobotState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::test::RobotState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::test::RobotState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::test::RobotState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::test::RobotState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::test::RobotState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::test::RobotState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::test::RobotState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::test::RobotState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::test::RobotState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9ebf5c3bc78dc310ULL;
  static const uint64_t static_value2 = 0xa9067120721e6ec8ULL;
};

template<class ContainerAllocator>
struct DataType< ::test::RobotState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::test::RobotState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::test::RobotState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::test::RobotState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::test::RobotState_<ContainerAllocator>& v)
  {
    s << indent << "vision_x: ";
...
#endif // TEST_MESSAGE_ROBOTSTATE_H
