...
xP = {
    ...
    # 'Ld': 3000,
    'F_max': 600, #60,  # Maximum force applied to the system
    'max_step': 2, #0.25,  # Max step size #this is apparently the limiting factor
...
thetaP = {
    ...
    'Ld': 1.9099e3,
    'F_max': 300, #30,  # Maximum force applied to the system
